<template>
  <div class="CardEquity">
    ...
    <div class="warning">
      ...
      <p>领取之后，该商家消费权益将绑定在该卡内，凭借上方二维码即可核销使用，游玩时间以商家有效期为准，部分商家需预约使用，最终解释权归属于时光里。</p>
    </div>
      ...
      <ul>
        <li>
          <div class="image">
            ...
            <p>剩余<span>1</span>次</p>
          </div>
          <div class="text">
            <h3>
              <span>龙湖时代天街悠游堂龙湖时代天街悠游堂龙湖时代天街悠游堂</span>
              <b>畅玩</b>
            </h3>
            <div class="text_div">
              <p>包含蹦床，滑梯</p>
              <p>有效期：2019-02-02至2019-02-02</p>
              <em>消耗1次权益</em>
            </div>
            <div class="price_div">
              <b>价值￥199</b>
    ...
    <div class="sub_btn"><span>去使用</span></div>
  </div>
</template>
<script>
    export default {
