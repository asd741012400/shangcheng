  ...
  <div class="CardActivate">
    ...
    <div class="user_message">
      ...
      <div class="user_sex box">
        ...
        <div class="boxs">
          <p>
            <i v-if="sexStuats != 1"><img src="../assets/icon_unselected.png" alt=""></i>
            <i v-else><img src="../assets/icon_pitch_on.png" alt=""></i>
            <span>王子</span>
          </p>
          <p>
            <i v-if="sexStuats != 2"><img src="../assets/icon_unselected.png" alt=""></i>
            <i v-else><img src="../assets/icon_pitch_on.png" alt=""></i>
            <span>公主</span>
          </p>
        </div>
    ...
    <div class="confirm_pop_bg" v-if="confirmPop">
      <div class="confirm_pop">
        <div class="boxs">
          ...
          <div class="agreement">
            <span>
              <img v-if="agreementStuats" src="../assets/icon_pitch_on.png" alt="">
              <img v-else src="../assets/icon_unselected.png" alt="">
            </span>
            <b>同意激活协议</b>
          </div>
          <div class="btn">
